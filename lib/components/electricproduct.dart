...
class electrics extends StatelessWidget {
  const electrics({Key? key}) : super(key: key);
            ...
            itemBuilder: (ctx, index) {
              return GestureDetector(
                onTap: () => Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: ((context) =>
                        DetailScreen(popularproduct: electric[index])),
                  ),
                ),
                child: Container(
                              ...
                              Container(
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    image: AssetImage(electric[index].picture),
                            ...
                            Padding(
                              ...
                              child: LikeButton(
                                ...
                                likeBuilder: (bool isLiked) {
                                  likeimage.add(electric[index].picture);
                                  likename.add(electric[index].title);
                                  likeprice.add(electric[index].price);
                                  return Icon(
